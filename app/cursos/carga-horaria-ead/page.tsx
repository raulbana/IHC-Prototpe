    ...
    <main className="min-h-screen bg-white text-gray-800 py-8 px-4 md:px-16">
      <section className="max-w-5xl mx-auto my-4 rounded-xl p-4">
        ...
        <div className="space-y-6">
          <p className="text-lg">
            Abaixo, apresentamos a lista dos cursos de graduação com carga
            horária EaD. As informações estão organizadas por setor, incluindo
            as disciplinas, a ementa e a bibliografia de cada curso, bem como a
            carga horária total.
          </p>
          <p className="text-lg">
            <b>Observação</b>: O carregamento da lista pode levar alguns
            segundos. Solicitamos a gentileza de aguardar enquanto as
            informações são carregadas.
          </p>
        </div>
      </section>

      <section
        className="max-w-5xl mx-auto my-4 rounded-xl p-4 bg-gray-50 shadow"
        ref={tabelaRef}
      >
        <h3 className="text-2xl font-semibold mb-4 text-default-blue">
          Navegue pelos Setores e Cursos
        </h3>
            ...
            <Select
              ...
              title={
                !setor
                  ...
                  : "Selecione um curso para ver apenas suas disciplinas"
              }
            />
          </div>
        </div>
